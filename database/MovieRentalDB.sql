...
-- 正在傾印表格  MovieRentalDB.Customers 的資料：~2 rows (近似值)
INSERT IGNORE INTO `Customers` (`CustomerID`, `LoginName`, `PasswordHash`, `PasswordSalt`, `NickName`, `MembershipLevel`, `About`, `Avatar`) VALUES
	('0699df65-a1e9-11ee-a139-0242ac140002', 'tooruche520', '$2b$12$pVbAu6U9MLsvILOh970tPORGoeUdLR.cxEPlNEGGlikt7McMAkDgS', '$2b$12$pVbAu6U9MLsvILOh970tPO', 'Tooruche0520', 'diamond', 'This is my account. HIHI', 'https://pbs.twimg.com/profile_images/1738905616108908544/2t1Z1AAm_400x400.jpg'),
	('63587741-a260-11ee-8d92-0242ac140002', 'hanchi_photato', '$2b$12$fYxsbGOi4yCjPIN0OlecOeb1n04Hx5mfFDtwaS/cOhLUfBw56LCOq', '$2b$12$fYxsbGOi4yCjPIN0OlecOe', 'hanchi', 'copper', '', 'https://yt3.googleusercontent.com/M8n9pCuCYMbWFENasXrUdD8TbtXVfyyyGowvrHF4982kDFq1MYepg3BokwfMjzyePDe1_amu=s176-c-k-c0x00ffffff-no-rj');
...
-- 正在傾印表格  MovieRentalDB.Movies 的資料：~4 rows (近似值)
INSERT IGNORE INTO `Movies` (`MovieID`, `Title`, `Genre`, `Actor`, `ReleaseDate`, `RentalPrice`, `CoverUrl`, `Discription`) VALUES
	...
	('36105f5c-a297-11ee-a660-0242ac140002', '水行俠 失落王國', '超級英雄', '溫子仁', '2023-12-22', 300, 'https://upload.wikimedia.org/wikipedia/zh/d/d4/Aquaman_and_the_Lost_Kingdom_Poster.jpg', '先前未能打敗水行俠的黑蝠鱝不計代價只求徹底擊敗水行俠，而這次黑蝠鱝掌握能釋放古老邪惡力量的遠古神器黑色三叉戟，變得比以往更加強大。為了對抗黑蝠鱝，水行俠必須向弟弟歐姆求助，兩人成為意想不到的盟友；兄弟倆必須克服己見，以保衛王國和全世界免於毀滅。'),
...
-- 正在傾印表格  MovieRentalDB.Rentals 的資料：~3 rows (近似值)
INSERT IGNORE INTO `Rentals` (`RentalID`, `CustomerID`, `MovieID`, `RentalDate`, `ReturnDate`, `RentalStatus`) VALUES
	...
	('c580bf67-aa04-11ee-b781-0242ac140002', '0699df65-a1e9-11ee-a139-0242ac140002', '377a5a3b-a297-11ee-a660-0242ac140002', '2023-11-03', '2025-03-05', 'Canceled'),
